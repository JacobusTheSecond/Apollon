...
\begin{document}
    ...
    $V := X\cup Y\cup {s,t,h,h'}$ and $E := (X\cup h)\times (Y\cup h') \cup {s}\times (X\cup h) \cup (Y\cup h')\times t$.
    \begin{figure}
        \centering
    ...
    %TODO \ldots -> \cdots?
    %TODO - consistency (Wassersteindistanz, Czech complex, n-cells, ...)
    %TODO reference all images
