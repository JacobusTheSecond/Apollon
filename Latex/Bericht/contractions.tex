\begin{figure}
    ...
    \begin{tikzpicture}[thick]
        ...
        \begin{scope}[shift={(\off,0)}]
            ...
            \path  [-{Latex[length=2mm,width=2mm]},red] (c) edge [yshift=2pt,loop above,min distance=15mm,in=170,out=100,looseness=10] node [above] {$c$} (c);
        \end{scope}


        \draw [-{Latex[length=2mm,width=2mm]},thick] (1.7,0) -- node [above] {Face $[b,a,c]$} node [below] {$b\mapsto [-c,-a]$} ({\off-0.7},0);
    \end{tikzpicture}
    }
