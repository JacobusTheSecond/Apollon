\begin{figure}
    ...
    \begin{tikzpicture}[thick]
        ...
        \draw [-{Latex[length=2mm,width=2mm]},thick] (1,0) --node [above] {Face $[a]$} node [below,text width=2cm,align=center] {$[a]\rightarrow []$} ({\off-1},0);
    \end{tikzpicture}
    }
    \hspace{1cm}
    \scalebox{\scale}{
    \begin{tikzpicture}[thick]
        ...
        \draw [-{Latex[length=2mm,width=2mm]},thick] (1.2,0) -- node [above] {Face $[a,b,b,-c]$} node [below] {$[a]\rightarrow [c,-b,-b]$} ({\off-0.7},0);
    \end{tikzpicture}
    }
    \par\bigskip
    ...
    \begin{tikzpicture}[thick]
        ...
        \draw [-{Latex[length=2mm,width=2mm]},thick] (1.7,0) -- node [above] {Face $[a,b,c]$} node [below,text width=2cm,align=center] {$[a]\rightarrow []$\\$[b]\rightarrow []$\\$[c]\rightarrow []$} ({\off-0.7},0);
    \end{tikzpicture}
    }
    \hspace{1cm}
    \scalebox{\scale}{
    \begin{tikzpicture}[thick]
        ...
        \draw [-{Latex[length=2mm,width=2mm]},thick] (1.7,0) -- node [above] {Face $[b,a,c]$} node [below,text width=3cm,align=center] {$[b]\rightarrow [-c,-a]$\\$[c]\rightarrow []$} ({\off-0.7},0);
    \end{tikzpicture}
    }
